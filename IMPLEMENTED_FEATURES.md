...
### Povinné požadavky:
- MVC architektura: **1 bod**
- Správně oddělené vrstvy: **5 bodů**
- Responzivní design (PC): **3 body**
- Responzivní design (mobil): **5 bodů**
- Kvalita webu: **6 bodů**
- Kvalita designu (pěkný): **5 bodů**
- Bcrypt hashování: **1 bod**
- Ošetření útoků: **1 bod**

**Celkem povinné: 27 bodů** (z max. 25)

### Volitelné rozšíření:
- Předvedení "do Vánoc": **10 bodů**
- SuperAdmin: **4 body**
- Unikátní názvy souborů: **2 body**
- Další vychytávky: **1 bod**
- Bootstrap (většinou): **4 body**
- JavaScript (různá místa): **2 body**
- AJAX (různá místa): **2 body**
- Twig (různá místa): **4 body**
- Composer: **1 bod**
- GIT: **1 bod**

**Celkem volitelné: 31 bodů** (z max. 34)

---

## Celkový odhad: 58 bodů

**Pozn.:** Finální bodování záleží na hodnotiteli, toto je odhad podle implementovaných funkcí.
